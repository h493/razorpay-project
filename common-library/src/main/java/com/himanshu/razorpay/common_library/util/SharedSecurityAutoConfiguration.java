package com.himanshu.razorpay.common_library.util;

import com.himanshu.razorpay.common_library.config.AesEncryptionConfig;
...
public class SharedSecurityAutoConfiguration {
    ...
    public BytesEncryptor masterKeyEncryptor(@Value("${vault.master-key}") String masterKey) {
        return new AesEncryptionConfig().masterKeyEncrypter(masterKey);
    }
