package com.himanshu.razorpay.payment_service.outbox;
...
import com.himanshu.razorpay.payment_service.repository.OutboxEventRepository;
...
public class OutboxPoller {
    ...
    @SchedulerLock(name = "payment-service-outbox-poller", lockAtLeastFor = "1s", lockAtMostFor = "2m")
    public void poll() {
