package com.himanshu.razorpay.vault_service.dto.request;


import com.himanshu.razorpay.vault_service.validation.ExpiryYear;
...
public record TokenizeRequest(
        ...
        @Size(min = 3, message = "Card Holder Name should have atleast 3 character")
